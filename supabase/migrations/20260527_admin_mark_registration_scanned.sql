-- Marcar inscrição/curso como escaneado manualmente pelo admin
...
COMMENT ON FUNCTION public.admin_mark_registration_course_scanned IS
  'Marca manualmente um vínculo inscrição/curso como escaneado (admin)';
