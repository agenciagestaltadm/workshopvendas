...
const courses = [
  {
    ...
    image: '/CHOCOLATES BEAN TO BAR (1).png',
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-slate-500 max-w-2xl mx-auto">
              Três dias de aprendizado prático com a chef <strong className="text-blue-500">Istefanny Cardoso</strong>
            </p>
          </div>
